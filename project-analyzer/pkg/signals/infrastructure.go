...
const (
	...
	SignalJavaScript InfraSignal = "javascript"
	SignalRust       InfraSignal = "rust"
	SignalJava       InfraSignal = "java"
	SignalKotlin     InfraSignal = "kotlin"
	SignalCSharp     InfraSignal = "csharp"
	SignalRuby       InfraSignal = "ruby"
	SignalPHP        InfraSignal = "php"
	SignalSwift      InfraSignal = "swift"
	SignalDart       InfraSignal = "dart"

	// Additional Frameworks
	SignalSpring  InfraSignal = "spring"
	SignalRails   InfraSignal = "rails"
	SignalLaravel InfraSignal = "laravel"
	SignalFiber   InfraSignal = "fiber"
	SignalEcho    InfraSignal = "echo"
	SignalNuxt    InfraSignal = "nuxt"
)
